        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <select
                ...
                className="w-full rounded-xl border border-neutral-800 bg-neutral-900 px-3 py-2 text-xs text-white focus:border-white focus:outline-none transition"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full resize-none rounded-xl border border-neutral-800 bg-neutral-900 p-3 font-mono text-xs text-neutral-200 placeholder-neutral-500 focus:border-white focus:outline-none transition leading-relaxed"
            />
          </div>
