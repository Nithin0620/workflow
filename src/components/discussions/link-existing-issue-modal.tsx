        ...
        <form onSubmit={handleLink} className="mt-5 space-y-4">
          <div>
            ...
            <div className="relative">
              <Search className="absolute left-3 top-2.5 h-4 w-4 text-neutral-500 dark:text-neutral-500" />
              <input
                type="text"
                ...
                required
                className="w-full rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900 dark:bg-neutral-100 pl-9 pr-3 py-2 text-xs text-white dark:text-black placeholder-neutral-500 focus:border-white dark:border-black focus:outline-none focus:ring-1 focus:ring-white transition font-mono"
              />
            </div>
