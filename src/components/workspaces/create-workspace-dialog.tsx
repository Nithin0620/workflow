        ...
        <form onSubmit={handleSubmit} className="mt-4 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 w-full font-mono rounded-xl border border-neutral-800 bg-black px-3.5 py-2.5 text-xs text-white placeholder:text-neutral-500 focus:border-neutral-600 focus:outline-none"
            />
          </div>
