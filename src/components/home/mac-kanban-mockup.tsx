...
export function MacKanbanMockup() {
  return (
    <section className="bg-black px-6 pb-32 pt-10 overflow-hidden">
      <div className="mx-auto max-w-6xl relative">
        ...
        <motion.div
          ...
          className="rounded-xl border border-neutral-800 bg-neutral-950 shadow-2xl shadow-white/5 overflow-hidden ring-1 ring-white/10"
        >
          ...
          <div className="h-10 bg-neutral-900 border-b border-neutral-800 flex items-center px-4 justify-between">
            ...
            <div className="text-[11px] font-medium text-neutral-400 flex items-center gap-2">
              <span className="font-mono bg-neutral-800/50 px-2 py-0.5 rounded border border-neutral-700/50">TripTally [TRIP]</span>
              <span>— Sprint 12</span>
            </div>
          ...
          <div className="p-6 bg-[#0a0a0a]">
            ...
            <div className="flex items-center justify-between border-b border-neutral-900 pb-4 mb-6">
              <div className="flex items-center gap-3">
                <span className="font-mono text-sm font-semibold text-white ml-2 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 relative">
              ...
              <div className="rounded-xl border border-neutral-900 bg-neutral-900/40 p-3 space-y-3">
                ...
                <div className="rounded-lg border border-neutral-800 bg-black p-3 space-y-2 opacity-60">
                  <span className="font-mono text-[10px] text-neutral-500">TRIP-103</span>
                  <p className="text-xs font-medium text-neutral-400">Improve dashboard performance</p>
              ...
              {/* Column 2: To Do */}
              <div className="rounded-xl border border-neutral-900 bg-neutral-900/40 p-3 space-y-3 relative">
                <div className="flex items-center justify-between px-1">
                ...
                <div className="h-[90px] rounded-lg border border-dashed border-neutral-800 bg-neutral-900/20"></div>

              </div>

              {/* Column 3: In Progress */}
              <div className="rounded-xl border border-white/10 bg-neutral-900/60 p-3 space-y-3 ring-1 ring-white/5 relative">
                <div className="flex items-center justify-between px-1">
                  <span className="text-xs font-bold uppercase tracking-wider text-white flex items-center gap-1.5">
                    <span className="h-1.5 w-1.5 rounded-full bg-white animate-pulse" />
                    In Progress
                  </span>
                  <span className="rounded-full bg-white text-black font-bold px-2 py-0.5 text-[10px] font-mono">2</span>
                </div>
                <div className="rounded-lg border border-neutral-700 bg-black p-3 space-y-2 shadow-lg">
                  ...
                  <p className="text-xs font-semibold text-white">Add payment gateway & webhooks</p>
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-neutral-800 text-[10px] text-neutral-400">
                    <span className="rounded bg-neutral-800 px-1.5 py-0.5 font-bold text-white">3 pts</span>
                ...
                >
                  ...
                  <div className="mt-1 ml-3 px-2 py-0.5 bg-blue-500 text-white text-[9px] font-bold rounded shadow-sm">Jules</div>
                </motion.div>
              </div>
              ...
              <div className="rounded-xl border border-neutral-900 bg-neutral-900/40 p-3 space-y-3">
                ...
                <div className="rounded-lg border border-neutral-800 bg-black p-3 space-y-2 opacity-50">
                  <span className="font-mono text-[10px] text-neutral-500">TRIP-99</span>
                  <p className="text-xs font-medium text-neutral-300 line-through">Set up PostgreSQL schema</p>
                  <div className="flex items-center justify-between pt-2 border-t border-neutral-900 text-[10px] text-neutral-500">
                    <span>Resolved</span>
        ...
        >
          <div className="bg-white text-black p-3 rounded-lg shadow-xl relative">
            <h4 className="font-bold text-xs mb-1">Instant Drag & Drop</h4>
            <p className="text-[10px] text-neutral-600 leading-tight">Fractional indexing updates DB instantly without reordering arrays.</p>
            <div className="absolute top-1/2 -right-2 transform -translate-y-1/2 w-4 h-4 bg-white rotate-45"></div>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-blue-500 text-white p-3 rounded-lg shadow-xl relative">
        ...
        >
          <div className="bg-neutral-800 border border-neutral-700 text-white p-3 rounded-lg shadow-2xl relative">
            <h4 className="font-bold text-xs mb-1">Keyboard First (⌘K)</h4>
            <p className="text-[10px] text-neutral-300 leading-tight">Navigate columns, assign users, or log points without touching the mouse.</p>
            <div className="absolute -top-2 left-1/2 transform -translate-x-1/2 w-4 h-4 bg-neutral-800 border-t border-l border-neutral-700 rotate-45"></div>
          </div>
        </motion.div>
