...
export function PlannedJourneysShowcase() {
  return (
    <section id="planned-journeys" className="relative overflow-hidden bg-black text-white px-6 py-24 border-t border-neutral-900">
      {/* ambient glow */}
      <div
        aria-hidden
      ...
      <div className="relative mx-auto max-w-6xl">
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10">
          ...
          <div className="max-w-md space-y-5">
            <span className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/[0.03] px-3.5 py-1.5 text-[11px] font-mono uppercase tracking-widest text-neutral-400">
            ...
            {showcase.map((s, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group cursor-pointer rounded-2xl border border-white/10 bg-white/[0.04] p-4 backdrop-blur-sm"
                >
                  <div
                  ...
                  <p className="mt-2.5 text-xs font-bold text-white">{s.name}</p>
                </motion.div>
              );
            })}
          </div>
