...
export function JourneyFooter() {
  return (
    <section className="relative overflow-hidden border-t border-neutral-900 dark:border-neutral-100 bg-black dark:bg-white px-6 py-20 text-white">
      <div
        aria-hidden
      ...
      >
        ...
        <p className="mx-auto max-w-xl text-sm sm:text-base text-neutral-400 dark:text-neutral-600 leading-relaxed">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-xl border border-white dark:border-black/15 bg-white dark:bg-black/[0.03] px-6 py-3.5 text-sm font-semibold text-white dark:text-black transition hover:border-white dark:border-black/30 hover:bg-white dark:bg-black/[0.06]"
          >
