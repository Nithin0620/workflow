    ...
    <section className="relative px-3 sm:px-6 pb-24 pt-6 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative z-10">
        ...
        <div className="text-center space-y-3 mb-8">
          <div className="inline-flex items-center gap-2 rounded-full border border-neutral-800 dark:border-neutral-200 bg-neutral-950/90 dark:bg-neutral-50/90 px-3 py-1 text-xs font-mono text-neutral-400 dark:text-neutral-600">
            <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
            <span>INTERACTIVE /board DEMO</span>
          </div>
          <h2 className="text-2xl sm:text-4xl md:text-5xl font-extrabold text-white dark:text-black tracking-tight">
            Try the real workspace board right now.
          </h2>
          <p className="text-xs sm:text-sm text-neutral-400 dark:text-neutral-600 max-w-2xl mx-auto px-4">
        ...
        <div
          ref={containerRef}
          className="rounded-2xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 shadow-2xl shadow-black/80 overflow-hidden ring-1 ring-white/10"
        >
          {/* Mac Window Title Bar */}
          <div className="h-10 bg-neutral-900 dark:bg-neutral-100 border-b border-neutral-800 flex items-center px-4 justify-between select-none">
            ...
            <div className="text-[11px] font-medium text-neutral-400 dark:text-neutral-600 flex items-center gap-2">
              <span className="font-mono bg-neutral-800/50 dark:bg-neutral-200/50 px-2 py-0.5 rounded border border-neutral-700/50 dark:border-neutral-300/50 text-white dark:text-black">
                TripTally [TRIP]
              </span>
              <span>— Sprint 12</span>
            </div>
            ...
            <div className="w-12 text-right">
              <span className="text-[10px] font-mono text-neutral-500 dark:text-neutral-500 uppercase">Demo</span>
            </div>
          </div>

          {/* App Body */}
          <div className="p-3 sm:p-5 bg-black dark:bg-white space-y-4">
            {/* Top Toolbar matching /board */}
            <div className="relative overflow-hidden rounded-2xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 p-4 shadow-xl">
              ...
              <div className="relative z-10 space-y-4">
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div className="flex items-center gap-3">
                    <h1 className="text-lg sm:text-xl font-extrabold tracking-tight text-white dark:text-black drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">
                      TripTally
                    </h1>
                    ...
                    <div className="flex items-center gap-1.5 rounded-full border border-neutral-800 dark:border-neutral-200 bg-neutral-950/90 dark:bg-neutral-50/90 px-2.5 py-0.5 text-[11px] font-medium text-neutral-400 dark:text-neutral-600 select-none backdrop-blur-sm">
                  ...
                  <div className="flex items-center gap-1.5">
                    <div className="flex items-center gap-1 rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900/80 dark:bg-neutral-100/80 px-2 py-1 backdrop-blur-sm shadow-sm">
                      <button
                        ...
                        className="text-neutral-400 dark:text-neutral-600 hover:text-white dark:text-black transition p-0.5"
                      >
                    ...
                    <div className="hidden sm:flex items-center gap-1.5 rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900/80 dark:bg-neutral-100/80 px-2.5 py-1 text-xs font-semibold text-neutral-300 dark:text-neutral-700 backdrop-blur-sm shadow-sm">
                ...
                <div className="flex flex-wrap items-center justify-between gap-4 sm:gap-6 pt-1">
                  ...
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                    ...
                    <div className="relative">
                      <Search className="absolute left-3 top-2.5 h-3.5 w-3.5 text-neutral-500 dark:text-neutral-500" />
                      <input
                        type="text"
                        value={search}
                        onChange={(e) => setSearch(e.target.value)}
                        placeholder="Search issues..."
                        className="w-32 sm:w-48 rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 py-1.5 pl-9 pr-3 text-xs text-white dark:text-black placeholder:text-neutral-500 focus:border-neutral-600 dark:focus:border-neutral-400 focus:outline-none"
                      />
                    </div>
                    ...
                    {/* AI Tag Filter Badge */}
                    <div className="flex items-center border-l border-neutral-800/80 dark:border-neutral-200/80 pl-3">
                      <button
                        onClick={() => setFilterTag(filterTag === "ai" ? "all" : "ai")}
                        className={`flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs font-bold transition ${
                          filterTag === "ai"
                            ? "border-purple-500 bg-purple-500 text-white dark:text-black shadow-md shadow-purple-950"
                            : "border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 text-neutral-400 hover:border-neutral-700 dark:hover:border-neutral-300 hover:text-white dark:text-black"
                        }`}
                      >
                        <span>AI Issues</span>
                    ...
                    {(onlyMyIssues || onlyUrgent || search || filterTag !== "all") && (
                      <button
                        ...
                        className="flex items-center gap-1.5 rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900 dark:bg-neutral-100 px-3 py-1.5 text-xs text-neutral-400 dark:text-neutral-600 hover:text-white dark:text-black transition"
                      >
                  ...
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4 ml-auto">
                    ...
                    <div className="hidden md:flex items-center gap-3">
                      <button
                        ...
                        className="flex items-center gap-2 rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 px-3 py-1.5 text-xs font-semibold text-neutral-300 dark:text-neutral-700 hover:border-neutral-700 hover:text-white dark:text-black transition"
                      >
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 rounded-xl bg-white dark:bg-black px-4 py-1.5 text-xs font-bold text-black dark:text-white shadow-lg transition hover:bg-neutral-200 dark:hover:bg-neutral-800"
                    >
                    ...
                    {/* View Mode Toggle */}
                    <div className="flex items-center rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 p-1">
                      <button
            ...
            {viewMode === "board" ? (
              <div className="relative">
                ...
                <div className="hidden xl:flex absolute -left-6 top-1/2 -translate-y-1/2 -translate-x-full z-30 pointer-events-none items-center">
                  <div className="w-48 rounded-xl bg-white dark:bg-black text-black p-3 shadow-2xl border border-neutral-200 dark:border-neutral-800 relative">
                    ...
                    <div className="absolute top-1/2 -right-1.5 -translate-y-1/2 h-3 w-3 rotate-45 bg-white dark:bg-black border-r border-t border-neutral-200 dark:border-neutral-800" />
                  </div>
                </div>
                ...
                <div className="hidden xl:flex absolute -right-6 top-1/3 -translate-y-1/2 translate-x-full z-30 pointer-events-none items-center">
                  <div className="w-48 rounded-xl bg-emerald-500 text-white dark:text-black p-3 shadow-2xl shadow-emerald-950/40 relative">
                  ...
                  {columns.map((col) => {
                    ...
                    return (
                      <div
                        ...
                        className={`flex h-full min-w-[270px] sm:min-w-[280px] max-w-[320px] flex-1 flex-col rounded-2xl bg-neutral-950 dark:bg-neutral-50 p-3.5 border transition-all duration-200 select-none ${
                          isDragTarget
                      ...
                      >
                        ...
                        {addingToStatus === col.key && (
                          <form
                            ...
                            className="mt-2.5 flex items-center gap-2 rounded-xl border border-neutral-700 dark:border-neutral-300 bg-neutral-900 dark:bg-neutral-100 p-2 shadow-inner"
                          >
                            <input
                              autoFocus
                              value={draftTitle}
                              ...
                              className="w-full bg-transparent text-xs text-white dark:text-black placeholder:text-neutral-500 focus:outline-none"
                            />
                            <button
                              type="submit"
                              className="shrink-0 rounded-lg bg-white dark:bg-black px-2 py-1 text-[10px] font-bold text-black dark:text-white hover:bg-neutral-200"
                            >
                              Add
                            </button>
                            <button
                              ...
                              className="text-neutral-400 dark:text-neutral-600 hover:text-white dark:text-black text-xs px-1"
                            >
                              ✕
                            </button>
                          </form>
                        ...
                        <div className="mt-3 flex-1 space-y-2.5 min-h-[140px] overflow-y-auto pr-0.5">
                          {colIssues.map((issue) => (
                            <div
                              ...
                              className={`group relative cursor-grab active:cursor-grabbing select-none rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900/80 dark:bg-neutral-100/80 p-3.5 shadow-md transition hover:border-neutral-500 dark:hover:border-neutral-500 hover:bg-neutral-900 dark:hover:bg-neutral-100 ${
                            ...
                            >
                              ...
                              {issue.tag === "ai" && (
                                <div className="hidden lg:flex absolute -top-12 right-0 z-30 pointer-events-none items-center">
                                  <div className="rounded-lg bg-purple-600/95 backdrop-blur-md px-2.5 py-1 text-white dark:text-black shadow-xl shadow-purple-950/60 border border-purple-400/40 whitespace-nowrap">
                              ...
                              {issue.tag === "cron" && issue.status === "TODO" && (
                                <div className="hidden lg:flex absolute -top-12 right-0 z-30 pointer-events-none items-center">
                                  <div className="rounded-lg bg-amber-500/95 backdrop-blur-md px-2.5 py-1 text-neutral-950 dark:text-neutral-50 shadow-xl shadow-amber-950/60 border border-amber-300/40 whitespace-nowrap">
                                    <p className="text-[10px] font-extrabold flex items-center gap-1">
                                      <Clock className="h-3 w-3" />
                                      Cron Jobs
                                    </p>
                                    <p className="text-[9px] text-neutral-900 dark:text-neutral-100 font-medium">
                              ...
                              <div className="flex items-center justify-between gap-2">
                                ...
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <GripVertical className="h-3.5 w-3.5 text-neutral-600 dark:text-neutral-400 opacity-0 group-hover:opacity-100 transition-opacity" />
                                </div>
                              </div>
              ...
              /* List View Mode */
              <div className="rounded-2xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 p-4 space-y-2">
                <div className="grid grid-cols-12 text-[11px] font-mono font-bold uppercase text-neutral-500 dark:text-neutral-500 pb-2 border-b border-neutral-800 dark:border-neutral-200 px-3">
                ...
                {filteredIssues.map((issue) => (
                  <div
                    key={issue.id}
                    className="grid grid-cols-12 items-center text-xs py-2 px-3 rounded-xl border border-neutral-800/60 dark:border-neutral-200/60 bg-neutral-900/40 dark:bg-neutral-100/40 hover:bg-neutral-900 transition"
                  >
                    <span className="col-span-2 font-mono font-bold text-neutral-400 dark:text-neutral-600">
                      {issue.projectKey}-{issue.issueNumber}
                    </span>
                    <span className="col-span-5 font-semibold text-white dark:text-black truncate pr-4">
                      {issue.title}
                    </span>
                    <div className="col-span-2">
                      <select
                        ...
                        className="rounded-lg border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 px-2 py-1 text-[11px] text-neutral-300 dark:text-neutral-700 font-medium focus:outline-none"
                      >
                        {columns.map((c) => (
                    ...
                    <div className="col-span-2 flex justify-end">
                      {issue.assignee ? (
                        <span className="text-[11px] text-neutral-300 dark:text-neutral-700 font-medium">
                          {issue.assignee.name}
                        </span>
                      ) : (
                        <span className="text-[11px] text-neutral-500 dark:text-neutral-500">Unassigned</span>
                      )}
                    </div>
                  </div>
                ))}
            ...
            <div className="pt-2 flex flex-wrap items-center justify-between gap-3 text-xs text-neutral-500 dark:text-neutral-500 font-mono">
        ...
        {activeNoteModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black dark:bg-white/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="relative w-full max-w-lg rounded-2xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 p-6 shadow-2xl space-y-5 ring-1 ring-white/10">
              <div className="flex items-start justify-between">
                <div className="flex items-center gap-3">
                  <div className="p-2 rounded-xl bg-neutral-900 dark:bg-neutral-100 border border-neutral-800">
                  ...
                  <div>
                    ...
                    <h3 className="text-base font-bold text-white dark:text-black mt-1">
              ...
              <p className="text-xs text-neutral-300 dark:text-neutral-700 leading-relaxed">
                {activeNoteModal.description}
              </p>

              <div className="rounded-xl border border-neutral-800/80 dark:border-neutral-200/80 bg-neutral-900/50 dark:bg-neutral-100/50 p-3.5 space-y-2">
                <p className="text-[11px] font-bold text-neutral-400 dark:text-neutral-600 uppercase tracking-wider font-mono">
                  Key Capabilities
                </p>
                <ul className="space-y-1.5 text-xs text-neutral-300 dark:text-neutral-700">
                  {activeNoteModal.points.map((pt, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <span className="h-1.5 w-1.5 rounded-full bg-white dark:bg-black mt-1.5 shrink-0" />
                      <span>{pt}</span>
                    </li>
                  ))}
                </ul>
              ...
              <div className="flex justify-end pt-2">
                <button
                  onClick={() => setActiveNoteModal(null)}
                  className="rounded-xl bg-white dark:bg-black px-4 py-2 text-xs font-bold text-black dark:text-white hover:bg-neutral-200 transition shadow-lg"
                >
                  Got It
                </button>
              </div>
