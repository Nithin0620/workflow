...
export function WorkspaceAiScanner({
  ...
  return (
    <div className="rounded-2xl border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 p-6 space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-800/80 dark:border-neutral-200/80 pb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-white dark:text-black">Autonomous AI Codebase Scanners</h2>
      ...
      <div className="rounded-xl border border-neutral-800 dark:border-neutral-200 bg-neutral-900/50 dark:bg-neutral-100/50 p-4 space-y-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Clock className="h-4 w-4 text-emerald-400" />
            <span className="text-xs font-bold text-white dark:text-black">Scheduled Automation Info (Daily 12:00 PM)</span>
          </div>
          <span className="rounded bg-neutral-900 dark:bg-neutral-100 border border-neutral-800 px-2 py-0.5 font-mono text-[10px] text-neutral-400 dark:text-neutral-600">
            0 12 * * *
          </span>
        </div>
        ...
        <div className="flex items-center justify-between rounded-lg border border-neutral-800 dark:border-neutral-200 bg-neutral-950 dark:bg-neutral-50 px-3 py-1.5 font-mono text-[11px] text-neutral-300 dark:text-neutral-700">
      ...
      {loading ? (
        ...
        <div className="py-6 text-center text-xs text-neutral-500 dark:text-neutral-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {items.map((item) => (
            <div
              key={item.projectId}
              className="flex flex-col justify-between rounded-xl border border-neutral-800/80 dark:border-neutral-200/80 bg-neutral-900/40 dark:bg-neutral-100/40 p-4 space-y-3"
            >
              <div className="flex items-start justify-between">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <h3 className="font-bold text-white dark:text-black text-sm">{item.projectName}</h3>
                    <span className="font-mono text-[11px] text-neutral-400 dark:text-neutral-600 bg-neutral-950 dark:bg-neutral-50 border border-neutral-800 px-1.5 py-0.5 rounded">
                      {item.projectKey}
                    </span>
                  </div>
                  ...
                  {item.repository ? (
                    <div className="flex items-center gap-1.5 text-xs text-neutral-400 dark:text-neutral-600">
                      ...
                      <span className="text-neutral-200 dark:text-neutral-800 font-semibold">
                        {item.repository.repoOwner}/{item.repository.repoName}
                      </span>
                      <span className="text-[11px] text-neutral-400 dark:text-neutral-600">({item.repository.defaultBranch})</span>
                    </div>
                  ) : (
                    <p className="text-xs text-neutral-500 dark:text-neutral-500 italic">No repository linked yet</p>
                  )}
                </div>
                ...
                <span
                  className={`flex items-center gap-1 rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider ${
                    item.repository?.status === "ACTIVE"
                      ...
                      : "bg-neutral-800 dark:bg-neutral-200 text-neutral-400"
                  }`}
                >
              ...
              <div className="flex items-center justify-between border-t border-neutral-800/60 dark:border-neutral-200/60 pt-2.5 text-xs text-neutral-400 dark:text-neutral-600">
                <div className="flex items-center gap-1">
                  <Clock className="h-3 w-3 text-neutral-400 dark:text-neutral-600" />
                  <span>
                    Last scanned:{" "}
                    <strong className="text-neutral-300 dark:text-neutral-700">
